...
public class HttpHandlerSpyOLD implements HttpHandler {
	...
	public String getResponseText() {
		...
		if (httpUrlConnection.getURL().toString().contains("metadataGroup/someMetadataGroupId")) {
			return "{\"record\":{\"data\":{\"children\":[{\"name\":\"nameInData\",\"value\":\"presentation\"}],\"name\":\"metadata\",\"attributes\":{\"type\":\"recordLink\"}},\"actionLinks\":{\"read\":{\"requestMethod\":\"GET\",\"rel\":\"read\",\"url\":\"http://localhost:8080/therest/rest/record/metadataRecordLink/linkedRecordPresentationPresentationLink\",\"accept\":\"application/vnd.cora.record+json\"}}}}";
		}
